...
The temperature in July is much higher than January, which indicates that New York is in the northern hemisphere. Outliers are not obvious in averaged data. 
